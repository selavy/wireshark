...
display.md_update_action = function(value)
  if value == 0 then
    return "Md Update Action: Md Update Action (0) (New)"
  end
  if value == 1 then
    return "Md Update Action: Md Update Action (1) (Change)"
  end
  if value == 2 then
    return "Md Update Action: Md Update Action (2) (Delete)"
  end
  if value == 3 then
    return "Md Update Action: Md Update Action (3) (Unknown)"
  end
  if value == 4 then
    return "Md Update Action: Md Update Action (4) (Unknown)"
  end
  if value == 5 then
    return "Md Update Action: Md Update Action (5) (Unknown)"
  end
